/* Comportamento extraído de cadastro-professor.html. */
...
// Toggle e Mascote
    ...
    function atualizarDino() {
        if (!dinoImg || !senhaInput) return;
        const temValor      = senhaInput.value.length > 0;
        const estaMostrando = senhaInput.type === 'text';
        if (estaMostrando) { dinoImg.src = '../../public/assets/imagens/dino espiando2.png'; return; }
        dinoImg.src = temValor ? '../../public/assets/imagens/dinosenha2.png' : '../../public/assets/imagens/dino2.png';
    }

    senhaInput.addEventListener('input', atualizarDino);
    senhaInput.addEventListener('blur',  atualizarDino);
    ...
    toggleSenhaIcon.addEventListener('click', () => {
        ...
        toggleSenhaIcon.innerHTML = oculta ? iconEyeSlash : iconEye;
        toggleSenhaIcon.title = oculta ? 'Ocultar senha' : 'Mostrar senha';
        atualizarDino();
    });
